...
###### Disclaimer: This is just a self practice for deployment using GitHub Pages based on this public template, which is on my purpose and may contains hidden issues, so do not treat this repo as a practice, treat the orginal one as practices. 
